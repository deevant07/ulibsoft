...
public class AbsoluteConstraints implements Serializable
  {
    ...
    */
    ...
    public AbsoluteConstraints(int x, int y)
      {
        this.x = (int)(x * ScreenResolution.SCREEN_WIDTH / defaultWidth);
        this.y = (int)(y * ScreenResolution.SCREEN_HEIGHT / defaultHeight);
      }
    ...
    public AbsoluteConstraints(int x, int y, int width, int height)
      {
        this.x		= (int)(x * ScreenResolution.SCREEN_WIDTH / defaultWidth);
        this.y		= (int)(y * ScreenResolution.SCREEN_HEIGHT / defaultHeight);
        this.width	= (int)(width * ScreenResolution.SCREEN_WIDTH / defaultWidth);
        this.height	= (int)(height * ScreenResolution.SCREEN_HEIGHT / defaultHeight);
      }
