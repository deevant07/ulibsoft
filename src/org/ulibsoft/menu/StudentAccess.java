...
import org.ulibsoft.reserve.StudentInput;
import org.ulibsoft.search.defaulters.StudentFineRecord;
     ...
     private void createComponents()
       {
          ...
          cmppn.add(k4 = new JLabel("K  .  Pavan  Kumar  ;  CSIT"),new AbsoluteConstraints(100,120));
          ...
          cmppn.add(k6 = new JLabel("T  .  Deevan  Kumar  ;  CSE"),new AbsoluteConstraints(100,160));
          ...
          cmppn.add(k9 = new JLabel("pavan_fantasy85@yahoo.com"),new AbsoluteConstraints(60,240));
          k9.setForeground(Color.white);
          k9.setFont(new Font(c.getFont().getFontName(),Font.PLAIN,13));

          cmppn.add(k10 = new JLabel("kumar_deevan2000@yahoo.com"),new AbsoluteConstraints(60,270));
          ...
          titPn1.add(fine= new JButton("FINED OBJECTIVES"),new AbsoluteConstraints(15+35,170+18,200,30));
          fine.setMnemonic('F');
         ...
         record.addActionListener(new ActionListener()
           {
              public void actionPerformed( ActionEvent e)
                {
                   new StudentRecord(Login.cname.getText());
                }
           }
         );
            ...
            public void actionPerformed(ActionEvent e)
              {
                if(e.getSource()==std)
                  {
                    INPUT = 1;
                   // JOptionPane.showMessageDialog(null,"csdvcsdcv");
                    new StudentInput();
                   // JOptionPane.showMessageDialog(null,"csdvcserfvevedcv");
                    setVisible(false);
                  }
                if(e.getSource()==stf)
                  {
                    INPUT = 2;
                    //JOptionPane.showMessageDialog(null,"CAN NOT ACESS ....... ?");
                    new StudentInput();
                    setVisible(false);
                  }
                if(e.getSource ()==exit)
