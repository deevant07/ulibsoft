...
public class StaffInput extends JFrame
  {
     private StaffInput p;
     private String day;
     int count11,count22;
     ...
     public StaffInput()
       {
         ...
         try
         {
          ...
          try
            {
               ...
               {
               rs=s.executeQuery("SELECT MIN_BOOKS,MAX_BOOKS,BOOK_HOLDING_PERIOD,IMAGE_PATH FROM KEYCONSTRAINTS WHERE ID=2");
               while(rs.next())
                 {
                    MIN_BOOKS=rs.getInt(1);
                    MAX_BOOKS=rs.getInt(2);
                 }
               rs = s.executeQuery ("SELECT COUNT(*) FROM BKTRANSACTION1 WHERE LID="+"'"+no.getText ()+"'" );
                     if(rs.next ())
                       {
               ...
               rs = s.executeQuery("SELECT COUNT(BOOKNAME) FROM STF_RESERVE WHERE LID='"+Login.cname.getText().toUpperCase()+"'");
               if( rs.next() )
                 {
               ...
               //CD
               if(StaffAccess.access==2)
               {
               rs=s.executeQuery("SELECT MIN_CDS,MAX_CDS FROM KEYCONSTRAINTS WHERE ID=2");
               while(rs.next())
                 {
                    MIN_CDS=rs.getInt(1);
                    MAX_CDS=rs.getInt(2);
               ...
               rs = s.executeQuery("SELECT COUNT(CDNAME) FROM STF_RESERVE WHERE LID='"+Login.cname.getText().toUpperCase()+"'");
               if( rs.next() )
                 {
                    count111=rs.getInt(1);
                    if( count111 < MIN_CDS  )
                 ...
                 //MAGAZINE
               if(StaffAccess.access==3)
               {
               rs=s.executeQuery("SELECT MIN_MZS,MAX_MZS FROM KEYCONSTRAINTS WHERE ID=2");
               while(rs.next())
                 {
                    MIN_MZS=rs.getInt(1);
                    MAX_MZS=rs.getInt(2);
               ...
               rs = s.executeQuery("SELECT COUNT(MZNAME) FROM STF_RESERVE WHERE LID='"+Login.cname.getText().toUpperCase()+"'");
               if( rs.next() )
                 {
                    count111=rs.getInt(1);
                    if( count111 < MIN_MZS  )
          ...
          if(StaffAccess.INPUT==1)
          componentListener1();
          if(StaffAccess.INPUT==2)
          componentListener2();
          if(StaffAccess.INPUT==3)
          componentListener3();
     ...
     private void createComponents()
       {
           ...
           p1.add(adno = new JLabel("==> PROFFESSOR  ID :"),new AbsoluteConstraints(30,30));
           ...
           if(StaffAccess.INPUT==3)
             {
                ...
                sop1.setBackground(Color.white);
                p1.add ( sop1, new AbsoluteConstraints( 165, 58, 200, 20 ) );
           ...
           try
             {
                s=con.createStatement();
                rs = s.executeQuery("SELECT LNAME FROM STAFF WHERE LID="+"'"+Login.cname.getText().toUpperCase()+"'");
                if( rs.next() )
                  {
                     MSG1=rs.getString(1)+"  !  .  .  .";
                  }
                                  ...
                                  if( rs.next() )
                                    {
                                       ...
                                       rs = s.executeQuery("SELECT COUNT(*) FROM STF_RESERVE WHERE "+constraints1);
                                       if( rs.next() )
                                         {
                                             count11=rs.getInt(1);
                                       ...
                                       if( count11 <= count22 )
                                            ...
                                            if(rs.next())
                                              {
                                                ...
                                                rs =s.executeQuery("SELECT LID FROM STF_RESERVE WHERE LID='"+Login.cname.getText().toUpperCase()+"'"+"AND "+constraints1);
                                                if( rs.next() )
                                                  {
                                                  ...
                                                  {
                                                      int wq=s.executeUpdate("INSERT INTO STF_RESERVE (LID,BOOKNAME,AUTHOR1,AUTHOR2,AUTHOR3,IDATE,TIME) VALUES("+"'"+no.getText()+"',"
                                                                                                                                                          +"'"+TITLE+"',"
                                                                                                                                                          +"'"+AUT1+"',"
                                                                                                                                                          +"'"+AUT3+"',"
                                                                                                                                                          +"'"+AUT5+"',"
                                       ...
                                       else if( count11 > count22)
                                         {
                                             ...
                                             rs = s.executeQuery("SELECT MIN(TO_DATE(BK.RDATE)) FROM BKTRANSACTION1 BK,LIBRARY LIB WHERE BK.CODE=LIB.ACESSNO AND "+constraints );
                                             if( rs.next() )
                                               {
                                  ...
                                  if( rs.next() )
                                    {
                                       ...
                                       if( count11 <= count22 )
                                            ...
                                            if(rs.next())
                                              {
                                                ...
                                                if( rs.next() )
                                                  ...
                                                  {
                                                     int wq=s.executeUpdate("INSERT INTO STF_RESERVE (LID,CDNAME,VERSION,SUBJECT1,IDATE,TIME) VALUES("+"'"+no.getText()+"',"
                                                                                                                                            +"'"+TITLE+"',"
                                                                                                                                            +"'"+AUT1+"',"
                                                                                                                                            +"'"+AUT3+"',"
                                                                                                                                            +"'"+date+"',"
                                       ...
                                       else if( count11 > count22)
                                         {
                                             ...
                                             rs = s.executeQuery("SELECT MIN(TO_DATE(BK.RDATE)) FROM CDTRANSACTION1 BK,CDDETAILS CD WHERE BK.CDCODE=CD.CDCODE AND "+constraints );
                                             if( rs.next() )
                                               {
                                                  msg4.setText("If  u  still  need , u  will  come  on  "+""+rs.getDate(1));
                                               }
                                  ...
                                  if( rs.next() )
                                    {
                                       ...
                                       if( count11 <= count22 )
                                            ...
                                            if(rs.next())
                                              {
                                                ...
                                                if( rs.next() )
                                                  ...
                                                  {
                                                      int wq=s.executeUpdate("INSERT INTO STF_RESERVE (LID,MZNAME,VOLUME,MONTH,PUBLISHER,IDATE,TIME) VALUES("+"'"+no.getText()+"',"
                                                                                                                                                             +"'"+TITLE+"',"
                                                                                                                                                          +"'"+AUT1+"',"
                                                                                                                                                          +"'"+AUT3+"',"
                                                                                                                                                          +"'"+AUT5+"',"
                                       ...
                                       else if( count11 > count22)
                                         {
                                             ...
                                             rs = s.executeQuery("SELECT MIN(TO_DATE(BK.RDATE)) FROM MZTRANSACTION1 BK,MZDETAILS MZ WHERE BK.MZCODE=MZ.ACCESSNO AND "+constraints );
                                             if( rs.next() )
                                               {
                                                  msg4.setText("If  u  still  need , u  will  come  on  "+""+rs.getDate(1));
                                               }
               ...
               public void actionPerformed(ActionEvent e)
                 {
                    ...
                    month.setText("");
                    pub.setText("");
                    JOptionPane.showMessageDialog(null,"dfq");
                    mzname1.setVisible(false);
                    sop1.setVisible(false);
                    ...
                    pub.setVisible(true);
                    JOptionPane.showMessageDialog(null,"dfq222");
                    constraints=null;
