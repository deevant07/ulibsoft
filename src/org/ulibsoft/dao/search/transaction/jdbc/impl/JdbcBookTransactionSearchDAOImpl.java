...
public class JdbcBookTransactionSearchDAOImpl implements
	...
	public List<BookModel> availableBooks()
	{
		...
		String FETCH_AVAILABLE = "SELECT LIB.ACESSNO ACESSNO,LIB.BOOKNAME BOOKNAME,LIB.AUTHOR1S,LIB.AUTHOR1F AUTHOR FROM LIBRARY LIB  WHERE LIB.ACESSNO NOT IN(SELECT BK.CODE FROM BKTRANSACTION BK WHERE BK.CODE=LIB.ACESSNO) AND LIB.ACESSNO NOT IN(SELECT BK1.CODE FROM BKTRANSACTION1 BK1 WHERE BK1.CODE=LIB.ACESSNO ) AND LIB.STATUS IS NULL ";
