...
public class ArchiveBooksSearch extends JFrame
  {
     private Container c;
     private JLabel but0;
     ...
     private JComboBox box12,box13,box14,box15,box16,box17;
     ...
     public ArchiveBooksSearch()
       {
           ...
           //FOR QUERY FORMING AND PROJECTION FOR QUERY
           componentListener();
       }
     ...
     private void createComponents()
       {
           ...
           c.add(cmppn,new AbsoluteConstraints(5,50,150,360));
           ...
           c.add(cmppn1,new AbsoluteConstraints(155,50,595+35,360));
           ...
           c.add(cmppn2,new AbsoluteConstraints(5,410,780,160));
           ...
           but10 = new JButton("PUBLISHED  YEAR");
           ...
           but11 = new JButton("PHYSICAL  MEDIUM");
           ...
           but12 = new JButton("PUBLISHED  PLACE");
           ...
           cmppn.add ( but15, new AbsoluteConstraints( 10, 247-5, 180-15-35, 18 ) );
           ...
           cmppn.add ( but16, new AbsoluteConstraints( 10, 266-5, 180-15-35, 18 ) );
           ...
           cmppn.add ( but17, new AbsoluteConstraints( 10, 285-5, 180-15-35, 18 ) );
           ...
           cmppn.add ( but18, new AbsoluteConstraints( 10, 304-5, 180-15-35, 18 ) );
           ...
           cmppn.add ( but19, new AbsoluteConstraints( 10, 323-5, 180-15-35, 18 ) );
           ...
           cmppn.add ( but20, new AbsoluteConstraints( 10, 342-5, 180-15-35, 18 ) );
     ...
     private void inputConstraints()
       {
          ...
          isbn.setFont(new Font(bookname.getFont().getFontName(),Font.BOLD,10));
          ...
          cmppn1.add ( note, new AbsoluteConstraints( 15, 155+20) );
          ...
          cmppn1.add ( note1, new AbsoluteConstraints( 145-20, 153+20, 150-15, 20 ) );
          ...
          cmppn1.add ( pub, new AbsoluteConstraints( 310+10, 155+20) );
          ...
          cmppn1.add ( pub1, new AbsoluteConstraints( 440-10+5, 153+20, 150-15, 20 ) );
          ...
          cmppn1.add ( pub2, new AbsoluteConstraints( 440-10+5, 153+20, 150-15, 20 ) );

          place = new JLabel( "PUBLISHED -- PLACE" );
          place.setFont(new Font(bookname.getFont().getFontName(),Font.BOLD,10));
          place.setForeground ( new Color ( 120, 120, 153 ) );
          cmppn1.add ( place, new AbsoluteConstraints( 15, 182+20) );
          ...
          cmppn1.add ( place1, new AbsoluteConstraints(  145-20, 180+20, 150-15, 20 ) );

          place2 = new JTextField( );
          place2.setBorder ( new MatteBorder ( 1, 1, 1, 1,new Color(0,0,40) ));
          place2.setForeground ( new Color ( 255, 0, 153 ) );
          cmppn1.add ( place2, new AbsoluteConstraints(  145-20, 180+20, 150-15, 20 ) );

          year = new JLabel( ">> PUBLISHED YEAR:" );
          year.setFont(new Font(bookname.getFont().getFontName(),Font.BOLD,10));
          year.setForeground ( new Color ( 120, 120, 153 ) );
          cmppn1.add ( year, new AbsoluteConstraints( 310+5+5, 182+20) );
          ...
          cmppn1.add ( year1, new AbsoluteConstraints( 440-10+5, 180+20, 150-15, 20 ) );

          phy = new JLabel( "PHYSICAL -- MEDIUM" );
          phy.setFont(new Font(bookname.getFont().getFontName(),Font.BOLD,10));
          phy.setForeground ( new Color ( 120, 120, 153 ) );
          cmppn1.add ( phy, new AbsoluteConstraints(15, 209+20) );

          phy1 = new JComboBox();
          phy1.addItem("");
          phy1.addItem("PAPER");
          phy1.addItem("THESIS");
          phy1.setBackground(Color.white);
          phy1.setBorder ( new MatteBorder ( 1, 1, 1, 1, new Color(0,0,40) ));
          phy1.setForeground ( new Color ( 255, 0, 153 ) );
          cmppn1.add ( phy1, new AbsoluteConstraints( 145-20, 207+20, 150-15, 20 ) );
          ...
          cmppn1.add ( sub1, new AbsoluteConstraints( 310+5+5, 209+20) );
          ...
          cmppn1.add ( sub11, new AbsoluteConstraints( 440-10+5, 207+20, 150-15, 20 ) );
          ...
          cmppn1.add ( sub2, new AbsoluteConstraints( 15, 236+20) );
          ...
          cmppn1.add ( sub21, new AbsoluteConstraints(145-20 , 234+20, 150-15, 20 ) );
          ...
          cmppn1.add ( sub22, new AbsoluteConstraints(145-20 , 234+20, 150-15, 20 ) );
          ...
          cmppn1.add ( sub3, new AbsoluteConstraints( 310+5+5,236+20) );
          ...
          cmppn1.add ( sub31, new AbsoluteConstraints( 440-10+5, 234+20, 150-15, 20 ) );
          ...
          box14 = new JComboBox();
          box14.setForeground( new Color( 255, 0, 153 ));
          box14.setBackground(Color.white);
          box14.addItem("");
          box14.addItem("OR");
          box14.addItem("AND");
          cmppn1.add (box14,new AbsoluteConstraints( 265, 97+28+28+28+28+20, 45 , 18 ) );

          box15 = new JComboBox();
          box15.setForeground( new Color( 255, 0, 153 ));
          box15.setBackground(Color.white);
          box15.addItem("");
          box15.addItem("OR");
          box15.addItem("AND");
          cmppn1.add (box15,new AbsoluteConstraints( 578, 97+28+28+28+28-2+20, 45 , 18 ) );

          box16 = new JComboBox();
          box16.setForeground( new Color( 255, 0, 153 ));
          box16.setBackground(Color.white);
          box16.addItem("");
          box16.addItem("OR");
          box16.addItem("AND");
          cmppn1.add (box16,new AbsoluteConstraints( 265, 97+28+28+28+28+28+20, 45 , 18 ) );

          box17 = new JComboBox();
          box17.setForeground( new Color( 255, 0, 153 ));
          box17.setBackground(Color.white);
          box17.addItem("");
          box17.addItem("OR");
          box17.addItem("AND");
          cmppn1.add (box17,new AbsoluteConstraints( 578, 97+28+28+28+28+28-3+20, 45 , 18 ) );
          ...
          cmppn1.add ( ins, new AbsoluteConstraints( 35+56, 300,110,27 ) );
          ...
          cmppn1.add ( search, new AbsoluteConstraints( 147+56, 300,110,27 ) );
          ...
          print.setMnemonic('P');
          cmppn1.add ( print, new AbsoluteConstraints( 147+56, 300,110,27 ) );
          ...
          cmppn1.add ( next, new AbsoluteConstraints( 371-56,300,110,27 ) );
          ...
          cmppn1.add ( quit, new AbsoluteConstraints( 483-56,300,110,27 ) );

       }

       //THIS IS FOR FLEXIBLE QUERY FORMING PURPOSE
       private void componentListener()
       {
          but3.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
               if(columnsParam == null)
                 {
                      columnsParam = "ACESSNO";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+"ACESSNO";
                 }
            }
          }
          );
          but4.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 {
                      columnsParam = "BOOKNAME,EDITION";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+"BOOKNAME,EDITION";
                 }
            }
          }
          );
          but5.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 {
                      columnsParam = "AUTHOR1S||AUTHOR1F AUTHOR1";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+"AUTHOR1S||AUTHOR1F AUTHOR1";
                 }
            }
          }
          );
          but6.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 {
                      columnsParam = "AUTHOR2S||AUTHOR2F AUTHOR2";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+"AUTHOR2S||AUTHOR2F AUTHOR2";
                 }
            }
          }
          );
          but7.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 ...
                 {
                      columnsParam = columnsParam+","+"AUTHOR3S||AUTHOR3F AUTHOR3";
                 }
            }
          }
          );
          but8.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 {
                      columnsParam = "PUBLISHER";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+"PUBLISHER";
                 }
            }
          }
          );
          but9.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 ...
                 {
                      columnsParam = columnsParam+","+"PLACE";
                 }
            }
          }
          );
         ...
         but11.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 {
                      columnsParam = "PHY_MEDM";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+"PHY_MEDM";
                 }
            }
          }
          );
         but13.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 ...
                 {
                      columnsParam = columnsParam+","+"ISBN";
                 }
            }
          }
          );
          but14.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 {
                      columnsParam = "SUBJECT1 DEPARTMENT";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+"SUBJECT1 DEPARTMENT";
                 }
            }
          }
          );
          but15.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 {
                      columnsParam = "SUBJECT2 COURSE";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+"SUBJECT2 COURSE";
                 }
            }
          }
          );
          but16.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 {
                      columnsParam = "SUBJECT3 SPECIFICATION";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+"SUBJECT3 SPECIFICATION";
                 }
            }
          }
          );
          but17.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 {
                      columnsParam = "DESCPRTN DESCRIPTION";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+"DESCPRTN DESCRIPTION";
                 }
            }
          }
          );
          but18.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 ...
                 {
                      columnsParam = columnsParam+","+"NOTE";
                 }
            }
          }
          );
          but19.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 {
                      columnsParam = "  TO_CHAR(ACESSDATE,'DD-MON-YYYY') ACESSDATE";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+" TO_CHAR(ACESSDATE,'DD-MON-YYYY') ACESSDATE";
                 }
            }
          }
          );
              ...
              public void actionPerformed(ActionEvent e)
                {
                      ...
                      try
                        {
                          s = con.createStatement();
                          rs = s.executeQuery( "SELECT DISTINCT(PLACE) FROM LIBRARY WHERE PLACE LIKE "+"'"+place2.getText().toUpperCase()+"%"+"'" );
                          while( rs.next() )
                           {
                              place1.addItem(rs.getObject(1));
                              ++flag2;
                           }
                           if(flag2>0)
                          {
        ...
        box1.addItemListener(new ItemListener()
                      ...
                      if(count10<1)
                        {
                           ...
                           if( note1.getText()==null || note1.getText().equals("") )
                             {
                                NOTE="";
                                //constraints=constraints+" ACESSDATE = "+"TO_CHAR('"+NOTE+"','DD-MON-YYYY')";
                             }
                           else
                             {
                              ...
                              if( item10 > 0 )
                                {
                                   constraints=constraints+" ACESSDATE = "+"TO_CHAR(TO_DATE('"+NOTE+"'),'DD-MON-YYYY')"+" "+(String)box10.getSelectedItem();
                                }
                             }
                           count10++;
                        }
                      ...
                      if(count11<1)
                        {
                           ...
                           if(PUB==null || PUB.equals(""))
                           {
                            ...
                            if( item11 > 0 )
                            {
                               constraints=constraints+" PUBLISHER = "+"'"+PUB+"'"+" "+(String)box11.getSelectedItem();
                            }
                           }
                         }
                        else
                           ...
                           if(PLACE==null || PLACE.equals(""))
                             {
                              ...
                              if( item12 > 0 )
                                {
                                   constraints=constraints+" PLACE = "+"'"+PLACE+"'"+" "+(String)box12.getSelectedItem();
                                }
                              }
                             }
                           else
                ...
                public void itemStateChanged(ItemEvent e)
                   {
                      if(count13<1)
                        {
                           item13++;
                           if( year1.getText()==null || year1.getText().equals("") ) { }
                           else
                           {
                              YEAR = year1.getText().toUpperCase();
                              if( item13 > 0 )
                                {
                                   constraints=constraints+" YEAR = "+"'" +YEAR+"'"+" "+(String)box13.getSelectedItem();
                                }
                           }
          ...
          box14.addItemListener(new ItemListener()
             {
                public void itemStateChanged(ItemEvent e)
                   {
                      if(count14<1)
                        {
                           item14++;
                           if( phy1.getSelectedItem()== null || phy1.getSelectedItem().equals("") ){ }
                           else
                             {
                                PHY = ((String)phy1.getSelectedItem()).toUpperCase();
                                if( item14 > 0 )
                                {
                                   constraints=constraints+" PHY_MEDM = "+"'"+PHY+"'"+" "+(String)box14.getSelectedItem();
                                }
                             }
          ...
          box15.addItemListener(new ItemListener()
             {
                public void itemStateChanged(ItemEvent e)
                   {
                      if(count15<1)
                        {
                           ...
                           if( sub11.getSelectedItem()== null || sub11.getSelectedItem().equals("") ){ }
                           else
                             {
                                ...
                                if( item15 > 0 )
                                {
                                   constraints=constraints+" SUBJECT1 = "+"'"+SUB1+"'"+" "+(String)box15.getSelectedItem();
                                }
                             }
                           count15++;
                        }
          ...
          box16.addItemListener(new ItemListener()
             {
                public void itemStateChanged(ItemEvent e)
                   {
                      if(count16<1)
                             ...
                             if(SUB2==null || SUB2.equals(""))
                               {
                                  ...
                                  if( item16 > 0 )
                                    {
                                       constraints=constraints+" SUBJECT2 = "+"'"+SUB2+"'"+" "+(String)box16.getSelectedItem();
                                    }
                                  }
                               }
                             else
          ...
          box17.addItemListener(new ItemListener()
             {
                public void itemStateChanged(ItemEvent e)
                   {
                      if(count17<1)
                        {
                           ...
                           if( sub31.getText()==null || sub31.getText().equals("") ) { }
                             else
                               {
                                  ...
                                  if( item17 > 0 )
                                    {
                                       constraints=constraints+" SUBJECT3 = "+"'"+SUB3+"'"+" "+(String)box17.getSelectedItem();
                                    }
                               }
            ...
            public void actionPerformed(ActionEvent e)
            {
              ...
              if( edt1.getText()==null || edt1.getText().equals("") ) { }
              else
                {
                   edition = edt1.getText().toUpperCase();
                   if( item2 > 0 ){}
                   else constraints=constraints+" EDITION = "+"'"+edition+"'";
                }
              ...
              if(TITLE==null || TITLE .equals(""))
                {
                  ...
                  if( TITLE==null || TITLE.equals("") ) {}
                    ...
                    {
                      if( item3 > 0 ) {}
                      else constraints=constraints+" BOOKNAME = "+"'"+TITLE+"'";
                    }
                }
              else
                {
              ...
              if(AUT1==null || AUT1.equals(""))
                {
                  ...
                  if(AUT1==null || AUT1.equals("")){}
                    ...
                    {
                      if( item4 > 0 ) {}
                      else constraints=constraints+" AUTHOR1S = "+"'"+AUT1+"'";
                    }
                }
              else
                {
              ...
              if(AUT2==null || AUT2.equals(""))
                {
                  ...
                  if(AUT2==null || AUT2.equals("")){}
                    ...
                    {
                      if( item5 > 0 ){}
                      else constraints=constraints+" AUTHOR1F = "+"'"+AUT2+"'";
                    }
                 }
               else
                 {
               ...
               if( AUT3==null || AUT3.equals("") )
                 {
                   ...
                   if( AUT3==null || AUT3.equals("") ){}
                     ...
                     {
                       if( item6 > 0 ) {}
                       else constraints=constraints+" AUTHOR2S = "+"'"+AUT3+"'";
                     }
                 }
               else
                 {
               ...
               if( AUT4==null || AUT4.equals("") )
                 {
                   ...
                   if( AUT4==null || AUT4.equals("") ) {}
                     ...
                     {
                        if( item7 > 0 ){}
                        else constraints=constraints+" AUTHOR2F = "+"'"+AUT4+"'";
                     }
                 }
               else
                 {
               ...
               if(AUT5==null || AUT5.equals(""))
                 {
                   ...
                   if(AUT5==null || AUT5.equals("")){}
                     ...
                     {
                       if( item8 > 0 ) {}
                       else constraints=constraints+" AUTHOR3S = "+"'"+AUT5+"'";
                     }
                 }
               else
                 {
               ...
               if( AUT6==null || AUT6.equals("") )
                 {
                   ...
                   if (AUT6==null || AUT6.equals("")){}
                     ...
                     {
                       if( item9 > 0 ){}
                       else constraints=constraints+" AUTHOR3F = "+"'"+AUT6+"'";
                     }
                 }
               else
                 {
               ...
               if( note1.getText()==null || note1.getText().equals("") )
               ...
               else
                 {
                    NOTE = note1.getText().toUpperCase();
                    if( item10 > 0 ){}
                    else constraints=constraints+" ACESSDATE = "+"TO_CHAR(TO_DATE('"+NOTE+"'),'DD-MON-YYYY')";
                 }
               ...
               if(PUB==null || PUB.equals(""))
                 {
                   ...
                   if(PUB==null || PUB.equals("")){}
                     ...
                     {
                       if( item11 > 0 ){}
                       else constraints=constraints+" PUBLISHER = "+"'"+PUB+"'";
                     }
                 }
               else
                 {
               ...
               if(PLACE==null || PLACE.equals(""))
                 {
                   ...
                   if(PLACE==null || PLACE.equals("")){}
                     ...
                     {
                       if( item12 > 0 ){}
                       else constraints=constraints+" PLACE = "+"'"+PLACE+"'";
                     }
                 }
               else
                 {
               ...
               if( year1.getText()==null || year1.getText().equals("") ) { }
               else
                 {
                   YEAR = year1.getText().toUpperCase();
                   if( item13 > 0 ){}
                   else constraints=constraints+" YEAR = "+"'" +YEAR+"'";
                 }
               ...
               if( phy1.getSelectedItem()== null || phy1.getSelectedItem().equals("") ){ }
               else
                 {
                   PHY = ((String)phy1.getSelectedItem()).toUpperCase();
                   if( item14 > 0 ){}
                   else constraints=constraints+" PHY_MEDM = "+"'"+PHY+"'";
                 }
               ...
               if( sub11.getSelectedItem()== null || sub11.getSelectedItem().equals("") ){ }
               else
                 {
                   SUB1 = ((String)sub11.getSelectedItem()).toUpperCase();
                   if( item15 > 0 ){}
                   else constraints=constraints+" SUBJECT1 = "+"'"+SUB1+"'";
                 }
               ...
               if(SUB2==null || SUB2.equals(""))
                 {
                   ...
                   if(SUB2==null || SUB2.equals("")){}
                     ...
                     {
                       if( item16 > 0 ){}
                       else constraints=constraints+" SUBJECT2 = "+"'"+SUB2+"'";
                     }
                 }
               else
                 {
               ...
               if( sub31.getText()==null || sub31.getText().equals("") ) { }
               else
                 {
                   SUB3 = sub31.getText().toUpperCase();
                   if( item17 > 0 ) {}
                   else constraints=constraints+" SUBJECT3 = "+"'"+SUB3+"'";
                 }
                   ...
                   if(columnsParam != null)
                     {
                       if(constraints.equals(""))
                         {
                           s = con.createStatement();
                           rs = s.executeQuery("SELECT "+columnsParam+" FROM LIBRARY ");
                           if(rs.next()) getTable(rs);
                           else JOptionPane.showMessageDialog(null,"NO  RECORDS  TO  DISPLAY   !  .  .  . ","BOOKS DATABASE",JOptionPane.INFORMATION_MESSAGE);
                           s.close();
                         }
                       else
                         {
                           s = con.createStatement();
                           rs = s.executeQuery("SELECT "+columnsParam+" FROM LIBRARY WHERE "+constraints );
                           if(rs.next()) getTable(rs);
                           else JOptionPane.showMessageDialog(null,"NO  RECORDS  TO  DISPLAY  !  .  .  . ","BOOKS DATABASE",JOptionPane.INFORMATION_MESSAGE);
                           s.close();
                         }
                       ...
                       if( constraints.equals(""))
                         {
                           ...
                           rs=s.executeQuery( " SELECT ACESSNO ACCESSNO, BOOKNAME ,"+
                                              " AUTHOR1S||AUTHOR1F AUTHOR1, AUTHOR2S||AUTHOR2F AUTHOR2,"+
                                              " AUTHOR3S||AUTHOR3F AUTHOR3, PUBLISHER, PLACE, YEAR,"+
                                              " PHY_MEDM, NOTE, SUBJECT1 DEPARTMENT, SUBJECT2 COURSE,"+
                                              " SUBJECT3 SPECIFICATION,TO_CHAR(ACESSDATE,'DD-MON-YYYY') ACESSDATE FROM LIBRARY ");
                           if(rs.next()) getTable(rs);
                           else JOptionPane.showMessageDialog(null,"NO  RECORDS  TO  DISPLAY !  .  .  .","BOOKS DATABASE",JOptionPane.INFORMATION_MESSAGE);
                           s.close();
                         }
                       else
                         {
                           ...
                           rs=s.executeQuery( " SELECT ACESSNO ACCESSNO, BOOKNAME ,"+
                                              ...
                                              " AUTHOR3S||AUTHOR3F AUTHOR3, PUBLISHER, PLACE, YEAR,"+
                                              " PHY_MEDM, NOTE, SUBJECT1 DEPARTMENT, SUBJECT2 COURSE,"+
                                              " SUBJECT3 SPECIFICATION,TO_CHAR(ACESSDATE,'DD-MON-YYYY') ACESSDATE FROM LIBRARY WHERE " +constraints );
             ...
             public void actionPerformed(ActionEvent e)
             {
               try
               {
                    ...
                    rs=s.executeQuery(" SELECT ACESSNO ACCESSNO, BOOKNAME ,"+
                                      ...
                                      " AUTHOR3S||AUTHOR3F AUTHOR3, PUBLISHER, PLACE, YEAR,"+
                                      " PHY_MEDM, NOTE, SUBJECT1 DEPARTMENT, SUBJECT2 COURSE,"+
                                      " SUBJECT3 SPECIFICATION, TO_CHAR(ACESSDATE,'DD-MON-YYYY') ACESSDATE FROM LIBRARY WHERE STATUS IS NOT NULL");
                    if(rs.next())
                    {
                     getTable(rs);
                    }
          ...
          next.addActionListener(new ActionListener()
           {
             public void actionPerformed(ActionEvent e)
             {
                ...
                item7=0;
                item8=0;
                item9=item10=item11=item12=item13=item14=item15=item16=item17=0;
