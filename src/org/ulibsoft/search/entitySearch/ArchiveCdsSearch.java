...
public class ArchiveCdsSearch extends JFrame
  {
     private Container c;
     private JLabel but0;
     ...
     private void createComponents()
       {
           ...
           c.add(cmppn,new AbsoluteConstraints(5,50,150,300-40));
           ...
           c.add(cmppn1,new AbsoluteConstraints(155,50,595+35,300-40));
           ...
           c.add(cmppn2,new AbsoluteConstraints(5,410-90,780,160+80));
           ...
           cmppn.add ( but3, new AbsoluteConstraints( 10, 20-5+5+5, 180-15-35, 18 ) );
           ...
           cmppn.add ( but4, new AbsoluteConstraints( 10, 38-5+5+5, 180-15-35, 18 ) );

           but5 = new JButton("SERIAL NUMBER");
           ...
           cmppn.add ( but5, new AbsoluteConstraints( 10, 57-5+5+5, 180-15-35, 18 ) );
           ...
           cmppn.add ( but6, new AbsoluteConstraints( 10, 76-5+5+5, 180-15-35, 18 ) );
           ...
           cmppn.add ( but7, new AbsoluteConstraints( 10, 95-5+5+5, 180-15-35, 18 ) );
           ...
           cmppn.add ( but8, new AbsoluteConstraints( 10, 114-5+5+5, 180-15-35, 18 ) );

           but9 = new JButton("MAG ACCESSION NO");
           ...
           cmppn.add ( but9, new AbsoluteConstraints( 10, 133-5+5+5, 180-15-35, 18 ) );

           but10 = new JButton(" STATUS ");
           ...
           cmppn.add ( but10, new AbsoluteConstraints( 10, 152-5+5+5, 180-15-35, 18 ) );
           ...
           cmppn.add ( but11, new AbsoluteConstraints( 10, 171-5+5+5, 180-15-35, 18 ) );


           but12 = new JButton("NOTE");
           ...
           cmppn.add ( but12, new AbsoluteConstraints( 10, 185+5+5, 180-15-35, 18 ) );

           but13 = new JButton("ACCESSED  DATE");
           ...
           cmppn.add ( but13, new AbsoluteConstraints( 10, 204+5+5, 180-15-35, 18 ) );

           but14 = new JButton("RECIEVE  DATE");
           ...
           cmppn.add ( but14, new AbsoluteConstraints( 10, 223+5+5, 180-15-35, 18 ) );
     ...
     private void inputConstraints()
       {
          bookname = new JLabel( "CD / FLOPPY TITLE :" );
...
/*          aut1s1 = new JComboBox( );
          ...
          */
          ...
          cmppn1.add ( aut1f, new AbsoluteConstraints( 310+15, 74+20 ) );
    ...
    /*      aut3f1 = new JComboBox( );
          ...
          cmppn1.add ( recieve, new AbsoluteConstraints( 15, 148+26) );
          ...
          cmppn1.add ( recieve1, new AbsoluteConstraints( 145-20, 146+26, 135, 20 ) );
          ...
          cmppn1.add ( note, new AbsoluteConstraints( 310+5+5,148+26) );
         ...
         // note1.setEditable(false);
          ...
          cmppn1.add ( note1, new AbsoluteConstraints( 440-10+5, 146+26, 150-15, 20 ) );
          ...
          cmppn1.add ( search, new AbsoluteConstraints( 147+56, 320-70-30-10,110,27 ) );
          ...
          print = new JButton( "PRINT" ) ;
            ...
            print.setMnemonic('P');
            cmppn1.add ( print, new AbsoluteConstraints( 147+56, 320-70-30-10,110,27 ) );
          ...
          cmppn1.add ( next, new AbsoluteConstraints( 371-56,320-70-30-10,110,27 ) );
          ...
          cmppn1.add ( quit, new AbsoluteConstraints( 483-56,320-70-30-10,110,27 ) );
          setVisible(true);
         ...
         but3.addActionListener(new ActionListener()
          ...
          but5.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 {
                      columnsParam = "CDSERIAL";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+"CDSERIAL";
                 }
            }
          }
          );
          ...
          but10.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 {
                      columnsParam = "CDSTATUS";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+"CDSTATUS";
                 }
            }
          }
          );
         ...
         but12.addActionListener(new ActionListener()
          ...
          but14.addActionListener(new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
                if(columnsParam == null)
                 {
                      columnsParam = "TO_CHAR(RDATE,'DD-MON-YYYY') RECEIVEDATE";
                 }
                 else
                 {
                      columnsParam = columnsParam+","+" TO_CHAR(RDATE,'DD-MON-YYYY') RECEIVEDATE ";
                 }
            }
          }
          );
                  ...
                  if( count2 < 1 )
                    {
                      if( edt1.getText()==null || edt1.getText().equals("") ) { }
                        ...
                        {
                           sno = edt1.getText().toUpperCase();
                           if( item2 > 0 )
                             {
                                constraints=constraints+" CDSERIAL = "+"'"+sno+"'"+" "+(String)box2.getSelectedItem();
                             }
                        }
                      count2++;
                    }
                  ...
                  if( count5 < 1 )
                    {
                      ...
                      if( aut1f1.getSelectedItem()==null || aut1f1.getSelectedItem().equals("") ) { }
                      else
                        {
                           ...
                           if( item5 > 0 )
                             {
                                constraints=constraints+" CDTYPE = "+"'"+type+"'"+" "+(String)box5.getSelectedItem();
                             }
                        }
                      count5++;
                    }
                  ...
                  if( count8 < 1 )
                    {
                      ...
                      if( aut3s1.getSelectedItem()==null || aut3s1.getSelectedItem().equals("") ) { }
                        ...
                        {
                           status=((String)aut3s1.getSelectedItem()).toUpperCase();
                           if( item8 > 0 )
                             {
                                constraints=constraints+" CDSTATUS = "+"'"+status+"'"+" "+(String)box8.getSelectedItem();
                             }
                        }
                      count8++;
                    }
                  ...
                  if( count9 < 1 )
                    {
                      ...
                      if( aut6.getText()==null || aut6.getText().equals("") ) { }
                      else
                        {
                           ...
                           if( item9 > 0 )
                             {
                                constraints=constraints+" SUBJECT = "+"'"+subject+"'"+" "+(String)box9.getSelectedItem();
                             }
                        }
                      count9++;
                    }
                   ...
                   if(count11<1)
                     {
                        ...
                        if( note1.getText()==null || note1.getText().equals("") ) { }
                        else
                          {
                             ...
                             if( item11 > 0 )
                             {
                                constraints=constraints+" ADATE = "+"TO_CHAR(TO_DATE('"+NOTE+"'),'DD-MON-YYYY')"+" "+(String)box11.getSelectedItem();
                             }
                          }
                        count11++;
                     }
                  ...
                  if( edt1.getText()==null || edt1.getText().equals("") ) { }
                      else
                        {
                           ...
                           if( item2 > 0 ) {}
                             ...
                             {
                                constraints=constraints+" CDSERIAL = "+"'"+sno+"'"+" ";
                             }
                        }
                   ...
                   if( aut3s1.getSelectedItem()==null || aut3s1.getSelectedItem().equals("") ) { }
                      else
                        {
                           ...
                           if( item8 > 0 ) {}
                             ...
                             {
                                constraints=constraints+" CDSTATUS = "+"'"+status+"'"+" ";
                             }
                        }
                    ...
                    if( note1.getText()==null || note1.getText().equals("") ) { }
                     ...
                     try
                     {
                         ...
                         else
                         {
                            ...
                            if(constraints.equals(""))
                             {
                               rs=s.executeQuery("SELECT CDCODE, CDNAME, CDVERSION, CDTYPE, SUBJECT, BKANO, MZACNO, TO_CHAR(ADATE,'DD-MON-YYYY') ACCESSED_DATE, TO_CHAR(RDATE,'DD-MON-YYYY') RECIEVED_DATE  FROM CDDETAILS ");
                               if(rs.next())
                                   {
                                      getTable(rs);
                                   }
                                   ...
                                   {
                                     JOptionPane.showMessageDialog(null,"NO RECORDS TO DISPLAY IN THE LIBRARY","CDS DATABASE",JOptionPane.INFORMATION_MESSAGE);
                                   }
                             }
                            else
                             {
                                rs=s.executeQuery("SELECT CDCODE, CDNAME, CDVERSION, CDTYPE, SUBJECT, BKANO, MZACNO, TO_CHAR(ADATE,'DD-MON-YYYY') ACESSDATE, TO_CHAR(RDATE,'DD-MON-YYYY') RECEIVE_DATE  FROM CDDETAILS WHERE "+constraints);
                                if(rs.next())
                                   {
                                      getTable(rs);
                                   }
        ...
        ins.addActionListener(new ActionListener()
         {
             public void actionPerformed(ActionEvent e)
             {
               ...
               {
                    s=con.createStatement();
                    rs=s.executeQuery("SELECT CDCODE, CDNAME, CDVERSION, CDTYPE, SUBJECT, BKANO, MZACNO,TO_CHAR(RDATE,'DD-MON-YYYY') RECEIVE_DATE,TO_CHAR(ADATE,'DD-MON-YYYY') ACESSDATE  FROM CDDETAILS WHERE STATUS IS NOT NULL");
                    if(rs.next())
                    {
                     getTable(rs);
                    }
               ...
               public void actionPerformed(ActionEvent e)
                 {
                     try
                     {
                       ...
                       boolean success= sttable.print( JTable.PrintMode.NORMAL,
                                                       new MessageFormat("ARCHIVE CD'S SEARCH ->"+date.getDate()+"/"+date.getMonth()+"/"+(1900+date.getYear())),
                                                       new MessageFormat("ARCHIVE CD'S SEARCH ->"+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds()),
                                                       true,
                                                       null,
                                                       true
                                                      );
